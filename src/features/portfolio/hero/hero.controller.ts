...
import { PortfolioStatusDto, HeroConfigDto, MetricDto, HeroResponseDto, PortfolioStatusResponseDto } from './hero.dto';
...
export class HeroController {
  ...
  @ApiResponse({ status: 200, description: 'Portfolio status successfully retrieved.', type: PortfolioStatusResponseDto })
  async getStatus() {
  ...
  @ApiResponse({ status: 201, description: 'Portfolio status successfully updated.', type: PortfolioStatusResponseDto })
  @ApiResponse({ status: 401, description: 'Unauthorized.' , schema: { example: { statusCode: 401, message: 'Unauthorized', error: 'Unauthorized' } }})
  ...
  @ApiResponse({ status: 200, description: 'Hero section data successfully retrieved.', type: HeroResponseDto })
  async getHero() {
  ...
  @ApiResponse({ status: 200, description: 'Hero section data successfully updated.', type: HeroResponseDto })
  @ApiResponse({ status: 401, description: 'Unauthorized.' , schema: { example: { statusCode: 401, message: 'Unauthorized', error: 'Unauthorized' } }})
  async updateHero(
    @Body()
    body: {
