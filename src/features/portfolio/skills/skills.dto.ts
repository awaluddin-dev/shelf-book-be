...
export class ProficiencySkillDto {
  ...
  @ApiProperty({
    description: 'Additional subtext or context for the skill',
  ...
  @ApiProperty({
    description: 'Current status or proficiency level',
    example: 'Advanced',
  })
  @IsString()
  status!: string;
...
export class ProficiencyDto {
  @ApiProperty({
    description: 'Title of the proficiency area',
  ...
  @ApiProperty({
    description: 'List of skills under this proficiency',
...
export class SkillDto {
  ...
  @ApiPropertyOptional({
    description: 'ID of the associated proficiency skill',
    example: 'prof-456',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    ...
    example: 'Strong understanding of static typing and advanced types.',
  })
  @IsString()
  details!: string;

  @ApiPropertyOptional({
    description: 'X-coordinate for visualizing the skill on a graph',
    example: 10,
  })
  @IsOptional()
  x?: number;
  ...
  @ApiPropertyOptional({
    description: 'Y-coordinate for visualizing the skill on a graph',
    example: 20,
  })
  @IsOptional()
  y?: number;
  ...
  @ApiPropertyOptional({
    description: 'List of connected skill IDs',
...
export class RoadmapDto {
  ...
  @ApiProperty({
    description: 'Target quarter for the roadmap item',
    example: 'Q3 2024',
  })
  @IsString()
  quarter!: string;
  ...
  @ApiProperty({
    ...
    example: 'Understanding queries, mutations, and subscriptions.',
  })
  @IsString()
  description!: string;

  @ApiPropertyOptional({
    description: 'Expected depth of knowledge',
  ...
  @ApiProperty({
    ...
    example: ['Apollo Server', 'Resolvers'],
  })
  @IsArray()
  @IsString({ each: true })
  topics!: string[];
  ...
  @ApiProperty({
    description: 'List of practical projects to build',
    example: ['E-commerce API', 'Real-time chat'],
  })
  @IsArray()
  @IsString({ each: true })
  projects!: string[];
