...
export class ExperienceController {
  ...
  @ApiResponse({ status: 200, description: 'List of testimonials successfully retrieved.', type: [TestimonialDto] })
  ...
  @ApiResponse({ status: 201, description: 'Testimonial successfully created.', type: TestimonialDto })
  ...
  @ApiResponse({ status: 200, description: 'Testimonial successfully updated.', type: TestimonialDto })
  @ApiResponse({ status: 401, description: 'Unauthorized.' , schema: { example: { statusCode: 401, message: 'Unauthorized', error: 'Unauthorized' } }})
  ...
  @ApiResponse({ status: 200, description: 'Testimonial successfully deleted.', type: TestimonialDto })
  @ApiResponse({ status: 401, description: 'Unauthorized.' , schema: { example: { statusCode: 401, message: 'Unauthorized', error: 'Unauthorized' } }})
  @ApiResponse({ status: 404, description: 'Testimonial not found.' })
  ...
  @ApiResponse({ status: 200, description: 'Work experiences successfully retrieved.', type: [WorkExperienceDto] })
  async getWork() {
  ...
  @ApiResponse({ status: 201, description: 'Work experience successfully created.', type: WorkExperienceDto })
  @ApiResponse({ status: 401, description: 'Unauthorized.' , schema: { example: { statusCode: 401, message: 'Unauthorized', error: 'Unauthorized' } }})
  ...
  @ApiResponse({ status: 200, description: 'Work experience successfully updated.', type: WorkExperienceDto })
  @ApiResponse({ status: 401, description: 'Unauthorized.' , schema: { example: { statusCode: 401, message: 'Unauthorized', error: 'Unauthorized' } }})
  ...
  @ApiResponse({ status: 200, description: 'Work experience successfully deleted.', type: WorkExperienceDto })
  @ApiResponse({ status: 401, description: 'Unauthorized.' , schema: { example: { statusCode: 401, message: 'Unauthorized', error: 'Unauthorized' } }})
  @ApiResponse({ status: 404, description: 'Work experience not found.' })
  ...
  @ApiResponse({ status: 200, description: 'Current foci successfully retrieved.', type: [CurrentFocusDto] })
  async getCurrent() {
  ...
  @ApiResponse({ status: 201, description: 'Current focus successfully created.', type: CurrentFocusDto })
  @ApiResponse({ status: 401, description: 'Unauthorized.' , schema: { example: { statusCode: 401, message: 'Unauthorized', error: 'Unauthorized' } }})
  ...
  @ApiResponse({ status: 200, description: 'Current focus successfully updated.', type: CurrentFocusDto })
  @ApiResponse({ status: 401, description: 'Unauthorized.' , schema: { example: { statusCode: 401, message: 'Unauthorized', error: 'Unauthorized' } }})
  ...
  @ApiResponse({ status: 200, description: 'Current focus successfully deleted.', type: CurrentFocusDto })
  @ApiResponse({ status: 401, description: 'Unauthorized.' , schema: { example: { statusCode: 401, message: 'Unauthorized', error: 'Unauthorized' } }})
  @ApiResponse({ status: 404, description: 'Current focus not found.' })
