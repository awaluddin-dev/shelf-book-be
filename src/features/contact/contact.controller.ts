...
export class ContactController {
  ...
  @ApiResponse({ status: 201, description: 'Inquiry successfully sent', type: ContactResponseDto })
  @ApiResponse({ status: 429, description: 'Too many requests (Rate limited)' , schema: { example: { statusCode: 429, message: 'Too many requests, please try again later.', error: 'Too Many Requests' } }})
  async sendInquiry(
